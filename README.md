...
My Team Cards Generator

## Description

With this generator you can populate an HTML file with cards based on the inputs that you choose from questions created with inquirer using node.js

## Link to deployed application

Navigate to [Deployed Application](https://github.com/wildnei/TeamProfileGenerator)
...
For more projects please check my [GitHub](https://github.com/github.com/wildnei) profile

## Technologies used

HTML,CSS,JavaScript,Nodejs,jQuery,Bootstrap,GitHub

## How to contribute to the project

Please fork the project or clone it and try to merge changes!
